...
class LatentSequenceDataset(Dataset):
    def __init__(self, processed_dir, seq_len=10, sequences=None):
        """
        Args:
            processed_dir: Path to folder containing '00.npz', '01.npz'
            seq_len: The window size for the RNN (e.g. 10)
            sequences: List of strings ['00', '01'] to load. If None, loads all.
        """
        ...
        if sequences is None:
            ...
            files = [os.path.join(processed_dir, f"{s}.npz") for s in sequences]
